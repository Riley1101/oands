...
static void error(char *message) { errorAt(&parser.previus, message); }
...
static void string() {
  emitConstant(
      OBJ_VAL(copyString(parser.previus.start + 1, parser.previus.length - 2)));
}
